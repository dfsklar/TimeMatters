...
var BoidsEngine = {
				...
				action: function(x, y) {
                    console.log("action was called");
						...
						this.particles.forEach(function(p){
							...
							if (Vector.distanceSquared(p.position,{x:x,y:y}) < 1000) {
								p.velocity.randomize(10);
    ...
    simulate: function simulate(dimensions, options) {
        ...
        // NO NEED FOR CHECKING READY STATE:
